...
class AppTheme {
  static Color lightBackgroundColor = const Color(0xfff2f2f2f);
  static Color lightPrimaryColor = const Color(0xff5485F3);
  ...
  static final lightTheme = ThemeData(
      ...
      textButtonTheme: TextButtonThemeData(
          style:
              TextButton.styleFrom(primary: lightBackgroundColor))); //ThemeData
